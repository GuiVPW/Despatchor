...
export type AggregatePostsLike = {
  count: number
  avg: PostsLikeAvgAggregateOutputType | null
  sum: PostsLikeSumAggregateOutputType | null
  min: PostsLikeMinAggregateOutputType | null
  max: PostsLikeMaxAggregateOutputType | null
}

export type PostsLikeAvgAggregateOutputType = {
  id: number
  postId: number
  userId: number
}

export type PostsLikeSumAggregateOutputType = {
  id: number
  postId: number
  userId: number
}

export type PostsLikeMinAggregateOutputType = {
  id: number
  postId: number
  userId: number
}

export type PostsLikeMaxAggregateOutputType = {
  id: number
  postId: number
  userId: number
}
...
export type PostsLikeAvgAggregateInputType = {
  id?: true
  postId?: true
  userId?: true
}

export type PostsLikeSumAggregateInputType = {
  id?: true
  postId?: true
  userId?: true
}

export type PostsLikeMinAggregateInputType = {
  id?: true
  postId?: true
  userId?: true
}

export type PostsLikeMaxAggregateInputType = {
  id?: true
  postId?: true
  userId?: true
}
...
export type AggregatePostsLikeArgs = {
  ...
  count?: true
  avg?: PostsLikeAvgAggregateInputType
  sum?: PostsLikeSumAggregateInputType
  min?: PostsLikeMinAggregateInputType
  max?: PostsLikeMaxAggregateInputType
}

export type GetPostsLikeAggregateType<T extends AggregatePostsLikeArgs> = {
  [P in keyof T]: P extends 'count' ? number : GetPostsLikeAggregateScalarType<T[P]>
}

export type GetPostsLikeAggregateScalarType<T extends any> = {
  [P in keyof T]: P extends keyof PostsLikeAvgAggregateOutputType ? PostsLikeAvgAggregateOutputType[P] : never
}
